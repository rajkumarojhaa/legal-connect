...
// Replace this with your router's Link (e.g. react-router-dom)
...
export default function SignIn() {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900 flex items-center justify-center p-6">
      {/* Animated Background */}
